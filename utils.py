    ...
    defaults = {
        ...
        "decay": {
            ...
            "emotion_weights": {
                "base": 1.0,
                "arousal_boost": 0.15,
                "short_term_emotion_mix": 0.15,
                "long_term_emotion_mix": 0.25,
            },
            "preservation": {
                "enable_high_importance": True,
                "high_importance_threshold": 7,
                "enable_fact_tags": True,
                "fact_tags": ["fact", "事实", "重要事实"],
                "preservation_score": 500.0,
            },
        },
        "matching": {
            "fuzzy_threshold": 50,
        ...
        "diary_mode": {
            "enabled": True,
            "surface_recent_days": 7,
            "disable_auto_resolve": True,
            "disable_urgency_boost": True,
            "merge_threshold": 85,
            "min_digest_entries": 1,
            "max_digest_entries": 3,
            "default_diary_importance": 4,
            "max_task_surfacing": 3,
            "passive_task_extraction": True,
        },
    }
